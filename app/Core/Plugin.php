...
use MXP\BlockAttributes\Utils\Singleton;
...
class Plugin extends Singleton {
	...
	public function setVersion(){
		...
		$plugin_data = get_plugin_data( $this->directoryPath . 'block-attributes.php' ) ;
		$this->version = $plugin_data['Version'] ;
	}

	private function setPluginUrl() {
		if( is_null($this->directoryPath) ){ return ; }
		$this->pluginUrl = trailingslashit( plugin_dir_url( $this->directoryPath ) . 'block-attributes' ) ;
	}
